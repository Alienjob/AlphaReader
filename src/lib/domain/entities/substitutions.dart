...
class AlphaReaderFont_3DUnicode implements AlphaReaderFont {
  @override
  String get family => '3DUnicode';

  @override
  AlphaReaderFont get next => AlphaReaderFont_ALKKaterina();
}

class AlphaReaderFont_ALKKaterina implements AlphaReaderFont {
  @override
  String get family => 'ALKKaterina';

  @override
  AlphaReaderFont get next => AlphaReaderFont_Datebashvili();
}

class AlphaReaderFont_Datebashvili implements AlphaReaderFont {
  @override
  String get family => 'Datebashvili';

  @override
  AlphaReaderFont get next => AlphaReaderFont_ARArchy();
}

class AlphaReaderFont_ARArchy implements AlphaReaderFont {
  @override
  String get family => 'ARArchy';

  @override
  AlphaReaderFont get next => AlphaReaderFont_BolnisiMtavruli();
}

class AlphaReaderFont_BolnisiMtavruli implements AlphaReaderFont {
  @override
  String get family => 'BolnisiMtavruli';

  @override
  AlphaReaderFont get next => AlphaReaderFont_BPGNuskhaModern();
}

class AlphaReaderFont_BPGNuskhaModern implements AlphaReaderFont {
  @override
  String get family => 'BPGNuskhaModern';

  @override
  AlphaReaderFont get next => AlphaReaderFont_Empty();
}

class AlphaReaderFont_Empty implements AlphaReaderFont {
  @override
  String get family => '';

  @override
  AlphaReaderFont get next => AlphaReaderFont_3DUnicode();
}
...
class Substitutions {
  ...
  static List<Substitution> _defaultPairs() {
    ...
    return [
      ...
      Substitution('ц', '\u10D0', false, ru),
      //Substitution('ц', '\u10D0', false, en),

      //Substitution('д', 'Ძ', false),
      Substitution('д', '\u10D1', false, ru),
      Substitution('d', '\u10D1', false, en),

      //Substitution('ц', 'Წ', false),
      Substitution('ц', '\u10D2', false, ru),
      //Substitution('ц', '\u10D2', false, en),

      //Substitution('ч', 'Ჭ', false),
      Substitution('ч', '\u10D3', false, ru),
      Substitution('ch', '\u10D3', false, en),

      //Substitution('к', 'Ხ', false),
      Substitution('к', '\u10D4', false, ru),
      Substitution('k', '\u10D4', false, en),

      //Substitution('д', 'Ჯ', false),
      Substitution('д', '\u10D5', false, ru),
      Substitution('d', '\u10D5', false, en),

      //Substitution('х', 'Ჰ', false),
      Substitution('х', '\u10D6', false, ru),
      Substitution('h', '\u10D6', false, en),
