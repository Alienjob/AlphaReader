...
mixin _$ShopState {
  ...
  StoreData get data => throw _privateConstructorUsedError;
...
abstract class $ShopStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isProcessing, String message, StoreData data});

  $StoreDataCopyWith<$Res> get data;
}
...
class _$ShopStateCopyWithImpl<$Res, $Val extends ShopState>
  ...
  @pragma('vm:prefer-inline')
  $StoreDataCopyWith<$Res> get data {
    return $StoreDataCopyWith<$Res>(_value.data, (value) {
...
class _$_ShopState implements _ShopState {
  const _$_ShopState(
      {required this.isProcessing, required this.message, required this.data});
  ...
  @override
  String toString() {
    return 'ShopState(isProcessing: $isProcessing, message: $message, data: $data)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isProcessing, message, data);
...
abstract class _ShopState implements ShopState {
  const factory _ShopState(
      ...
      required final StoreData data}) = _$_ShopState;
